...
def get_all_severities():
    ...
    return [serialize_severity(severity) for severity in severities], 200
...
def create_alert(data):
    ...
    severity = AlertSeverity.query.get(data["severity_id"])

    if not severity:
        return {"error": "Invalid severity_id"}, 400
